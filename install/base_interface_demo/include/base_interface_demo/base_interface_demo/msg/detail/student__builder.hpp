...
class Init_Student_weight
{
public:
  explicit Init_Student_weight(::base_interface_demo::msg::Student & msg)
  : msg_(msg)
  {}
  ::base_interface_demo::msg::Student weight(::base_interface_demo::msg::Student::_weight_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Student_weight height(::base_interface_demo::msg::Student::_height_type arg)
  {
    msg_.height = std::move(arg);
    return Init_Student_weight(msg_);
  }
