...
#include "base_interface_demo/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interface_demo::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_interface_demo::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interface_demo::msg::Student *>(
    untyped_ros_message);
...
{
  return &base_interface_demo::msg::typesupport_fastrtps_cpp::_Student__handle;
}
