...
static const _AddInts_Request_type_support_symbol_names_t _AddInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interface_demo, srv, AddInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_interface_demo, srv, AddInts_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, base_interface_demo, srv, AddInts_Request)() {
  return &::base_interface_demo::srv::rosidl_typesupport_c::AddInts_Request_message_type_support_handle;
}
...
static const _AddInts_Response_type_support_symbol_names_t _AddInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interface_demo, srv, AddInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_interface_demo, srv, AddInts_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, base_interface_demo, srv, AddInts_Response)() {
  return &::base_interface_demo::srv::rosidl_typesupport_c::AddInts_Response_message_type_support_handle;
}
...
static const _AddInts_type_support_symbol_names_t _AddInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interface_demo, srv, AddInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, base_interface_demo, srv, AddInts)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, base_interface_demo, srv, AddInts)() {
  return &::base_interface_demo::srv::rosidl_typesupport_c::AddInts_service_type_support_handle;
}
