...
static const _AddInts_Request_type_support_symbol_names_t _AddInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface_demo, srv, AddInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interface_demo, srv, AddInts_Request)),
  }
};
...
{
  return &::base_interface_demo::srv::rosidl_typesupport_cpp::AddInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interface_demo, srv, AddInts_Request)() {
  return get_message_type_support_handle<base_interface_demo::srv::AddInts_Request>();
}
...
static const _AddInts_Response_type_support_symbol_names_t _AddInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface_demo, srv, AddInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interface_demo, srv, AddInts_Response)),
  }
};
...
{
  return &::base_interface_demo::srv::rosidl_typesupport_cpp::AddInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interface_demo, srv, AddInts_Response)() {
  return get_message_type_support_handle<base_interface_demo::srv::AddInts_Response>();
}
...
static const _AddInts_type_support_symbol_names_t _AddInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interface_demo, srv, AddInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interface_demo, srv, AddInts)),
  }
};
...
{
  return &::base_interface_demo::srv::rosidl_typesupport_cpp::AddInts_service_type_support_handle;
}
