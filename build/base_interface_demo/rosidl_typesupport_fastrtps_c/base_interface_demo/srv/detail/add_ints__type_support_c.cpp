...
#include "base_interface_demo/srv/detail/add_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddInts_Request__ros_msg_type = base_interface_demo__srv__AddInts_Request;
...
size_t get_serialized_size_base_interface_demo__srv__AddInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interface_demo__srv__AddInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interface_demo
size_t max_serialized_size_base_interface_demo__srv__AddInts_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interface_demo__srv__AddInts_Request;
    is_plain =
      (
...
static size_t _AddInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interface_demo__srv__AddInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interface_demo, srv, AddInts_Request)() {
...
using _AddInts_Response__ros_msg_type = base_interface_demo__srv__AddInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interface_demo
size_t get_serialized_size_base_interface_demo__srv__AddInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddInts_Response__ros_msg_type * ros_message = static_cast<const _AddInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interface_demo__srv__AddInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interface_demo
size_t max_serialized_size_base_interface_demo__srv__AddInts_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_interface_demo__srv__AddInts_Response;
    is_plain =
      (
...
static size_t _AddInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interface_demo__srv__AddInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interface_demo, srv, AddInts_Response)() {
...
// already included above
// #include "base_interface_demo/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "base_interface_demo/srv/add_ints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interface_demo, srv, AddInts)() {
